...
module.exports = {
  helpUserGet(){
    ...
    console.log(chalk.white('  If an operator has user edit access or they are requesting their own user they can use this command to retrieve all information attached to a user.'));
    console.log();
